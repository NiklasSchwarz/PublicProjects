...
OUTPUT_CHANNELS     = 16                                                        # Hadamard output channels (size of Hadamard codes)
HADAMARD_SIZE       = (NUM_CLASSES, OUTPUT_CHANNELS)                            # Size of Hadamard codes
AUGMENTED           = True                                                     # Whether to use augmented Hadamard codes
ACCOMULATIVE_COUNTS = 4                                                         # Number of iterations to accumulate gradients
